...
<tr>
	<td>Full Name</td><td><input type="text" name="full_name" id='full_name' maxlength="100" size="30px"></td>
</tr>
<tr>
...
<tr>
	<td>Class</td><td><input type="text" name="class" id="class" maxlength="3"></td>
</tr>
<tr>
...
?>
	...
	<table class='itemlist' cellpadding=3 cellspacing=1 width='600px'>
		...
		<?php 
			...
			$data_row = get_students($_start, $_limit);
			$counter = 0;
			...
			echo "
				...
				<tr>
					...
					<td>".$data['class']."</td><td>".$status."</td><td align='center'>".$delete_button."  ".$edit_button." </td>
				</tr>
...
function get_students($start = 0, $limit = 10){

	$query = "SELECT *  FROM students ORDER BY register_number ASC LIMIT $start, $limit";
