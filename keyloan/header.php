...
<title>FiGi :: Key</title>
<link rel="shortcut icon" type="image/x-icon" href="../images/figiicon.ico" />
<link rel="stylesheet" href="<?php echo $figi_dir.STYLE_PATH ?>deskcopy.css" type="text/css" media="screen" />
...
<div id="title">
<?php if ($_mod == 'loan') { ?>
    FiGi Key <span class="underline">LOAN</span> Module
<?php } else { ?>    
    FiGi Key <span class="underline">RETURN</span> Module
<?php } ?>
</div>
