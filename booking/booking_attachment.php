...
if ($_name != null)
    $query = 'SELECT filename,data FROM booking_list_attachment WHERE filename = "' .$_name . '"';
else
    $query = 'SELECT filename,data FROM booking_list_attachment WHERE id_attach = ' .$_id;
