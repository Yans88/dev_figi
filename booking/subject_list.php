...
*/
echo '<h4>Subject Management</h4>';
if (!SUPERADMIN) {
?>

<div style="text-align: left; width:400px " class="middle">
<a class="button" id="add_subject_btn" href="#" >Add Subject</a>
</div>
<?php
}
?>
...
if ($item_count>0){
	foreach ($subjects as $rec) {
	  ...
	  //if (!SUPERADMIN && )
		$edit_link =<<<EDIT
		<a href="#$rec[id_subject]" title="edit" class="edit"><img class="icon" src="images/edit.png" alt="edit"></a>
		<a href="#$rec[id_subject]" class="dele"  title="delete"><img class="icon" src="images/delete.png" alt="delete"></a>
EDIT;
	  $counter++;
	  ...
	  <tr $_class>
		...
		<td id="td$rec[id_subject]">$rec[subject_name]</td>
