...
if (isset($_POST['unapprove']) && ($_POST['unapprove'] == 1)){
    ...
    if (mysql_affected_rows()>0){
    	...
    	send_unapproved_service_request_notification($_id);
    }
...
<div class="submod_title"><h4 style="color: #fff">$caption</h4></div>
...
if ($rec['status'] == PENDING) {
  ...
  <table cellpadding=4 cellspacing=1 class="service_table form" >
    ...
    <tr valign="top">  
      <td align="left">Remarks</td>
      <td align="left"><textarea rows=3 cols=55 name="remark"></textarea></td>    
    </tr>
    <tr valign="top" class="alt">  
  ...
  <div class="service_table normal" style=" text-align: right; ">
