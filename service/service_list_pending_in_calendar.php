...
$_part = $_GET['part'];	
if(!$_part){
$_part='implementation';//	header('location: ./?mod=report');
}
...
<script type='text/javascript' src='<?php echo $js_path?>/services_<?php echo $_part;?>.js'></script>
<script type='text/javascript' src='<?php echo $js_path?>/jquery/jquery.tooltip.pack.js'></script>
<span class="fc-button fc-button-next fc-state-default fc-corner-left"><span class="fc-button-inner"><span class="fc-button-content" id="toggle-button">&nbsp;Show Calendar&nbsp;</span><span class="fc-button-effect"></span></span></span> &nbsp; &nbsp;
<span class="fc-header-center calendar_wrapper" >
...
<div id='calendar' class="calendar_wrapper" ></div>
...
$('#toggle-button').click(function(){
	var d = $('.calendar_wrapper').css('display');
	//alert(d)
	if (d=='none'){
