...
if (isset($_POST['import']) ) {
	...
	if (is_uploaded_file($_FILES['csv']['tmp_name'])) 
		...
		$err = import_csv_expendable_item($_FILES['csv']['tmp_name'], USERDEPT);
...
<tr>
  <td align="center"> 
    ...
    <button type="button" onclick="location.href='./?mod=expendable';">Cancel</button>  
    </td>
</tr>  
</table>  
</form>
<?php
if ($_msg != null)
	echo '<script>alert("'. $_msg . '");location.href="./?mod=expendable";</script>';
?>