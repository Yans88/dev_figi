...
$_dept = !empty($_GET['id_dept']) ? $_GET['id_dept'] : 0; //edit
...
$item_f = array('id_category'=>$_category,'model_no'=>$model_no,'id_status'=>$_status,'id_location'=>$_id);
...
<div style="float: right">
    ...
    <a class="button" href="./?mod=report&sub=item&term=export&by=store&chgord=1&searchby=id_store&id_store=<?php echo $_searchtext?>&ordby=<?php echo $_orderby?>&id_department=<?php echo $_GET['id_department']?>&id_category=<?php echo $_GET['id_category']?>&id_location=<?php echo $_GET['id_location']?>&model_no=<?php echo $_GET['model_no']?>&id_status=<?php echo $_GET['id_status']?>">Export</a>
...
<?php
//echo "<script>alert('".$_GET['id_dept']."')</script>";
