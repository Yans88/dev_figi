...
if ($_id > 0){
    ...
    $history_in = machrec_get_history_in($_id);
...
<h4>Machine Maintenance Return (View)</h4>
<form method="post">
...
<tr valign="top">
    ...
    <table width="100%" cellpadding=2 cellspacing=1 class="request" >
      <tr valign="middle">  
        ...
        <td align="left"><?php echo $history['vendor_name']; if ($history['repair_type'] =='internal') echo '&nbsp; [Internal Repair]';?></td>
...
<tr valign="top"><th colspan=2 align="center"> Returned Info  </th></tr>
<tr valign="top">
    <td width="50%">
        <table class="pic_table" cellpadding=1 cellspacing=1 width="100%" >
        <tr><th colspan=2>Received By</th></tr>
        <tr>
            <td width=100>Name:</td>
            <td ><?php echo $history_in['received_by']?></td>
        </tr>
        <tr class="alt">
            <td>Returned Date</td>
            <td><?php echo $history_in['received_date']?></td>
        </tr>   
    </table>
    </td>
    <td width="50%">
        <table class="pic_table" cellpadding=1 cellspacing=1 width="100%" >
        <tr><th colspan=2>Returned By</th></tr>
        <tr>
            <td width=100>Name:</td>
            <td ><?php echo $history_in['vendor_contact_name']?></td>
        </tr>
        <tr class="alt">
            <td>Contact No</td>
            <td><?php echo $history_in['vendor_contact_no']?></td>
        </tr>
 <?php
...
?>
       <tr>
        <td class="pic left bottom">Signatures</td>
        <td class="pic right bottom"><img class="signature" src="<?php echo machrec_get_return_signature($_id)?>" /></td>
        </tr>
<?php
    } // approval
?>    
