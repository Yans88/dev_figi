...
$order_link = './?mod=loan&sub=find_item&act=list&chgord=1&searchby='.$_searchby.'&searchtext='.$_searchtext.'&page='.$_page.'&ordby=';

?>
<form method="get" action="?mod=loan&sub=find_item">
<div id="submodhead" >
<script>
...
while ($rec = mysql_fetch_array($rs))
{
	...
	<td><a target="item_view" href="?mod=item&act=view&id=$rec[id_item]" title="view">$rec[asset_no]</a> </td>
	<td>$rec[serial_no]</td>
...
echo make_paging($_page, $total_page, './?mod=loan&sub=find_item&act=list&searchby='.$_searchby.'&searchtext='.$_searchtext.'&page=');
echo  '</td></tr></table><br/>';
