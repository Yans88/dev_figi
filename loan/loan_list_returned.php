...
$data = get_request_by_status(RETURNED, $_start, $_limit, 'end_loan', 'DESC');

$counter = 0;
if ($total_item > 0){
?>
<h3>Loaned Items Pending Acknowlegement</h3>
<table cellpadding=2 cellspacing=1 class="loan_table item-list" >
<tr height=30 valign="top">
  <th width=35>No</th>
  <th width=120>Date of Return</th>
  <th>Requestor</th>
...
DATA;
	...
	echo '<p align="Center" ><h3>Loaned Items Pending Acknowlegement</h3><p class="error">Data is not available!</p></p>';
