...
$(function(){
    ...
    var Events = Backbone.Collection.extend({
		...
		url: './calendar/services_implementation.php'
    ...
    var EventsView = Backbone.View.extend({
        ...
        select: function(startDate, endDate, allDay) {
            ...
            this.eventView.model = new Event({start: startDate, end: endDate, allDay: allDay, status: status});
    ...
    var EventView = Backbone.View.extend({
        ...
        detail: function() {
            ...
            var url = "./?mod=service&sub=service&act=view&id="+id+" status is"+url;
			//var url = url;
            location.href = url; 
        },
        close: function() {
