...
$(function(){
    ...
    var Events = Backbone.Collection.extend({
        model: Event,
        //url: './calendar/events.php' //'events'		url: './calendar/services.php'
    }); 
    ...
    var EventView = Backbone.View.extend({
        ...
        detail: function() {
            ...
            var url = "./?mod=calendar&act=edit&dts="+start+"&dte="+end;
            
            if (location.href.search(/portal/)>-1)
                url = "./?mod=portal&portal=calendar&act=edit&dts="+start+"&dte="+end;
